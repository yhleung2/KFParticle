...
class KFParticleTopoReconstructor{
 public:
  ...
  void SetTarget(const std::array<double, 3> &target) { fKFParticlePVReconstructor->SetTargetPosition(target); } ///< Sets the target position for reconstruction of the primary vertex.
